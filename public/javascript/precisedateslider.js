...
PreciseDateSlider = Class.create({
	...
	createHandles : function(p_sBarId, p_sStartDate, p_sEndDate) {
		...
		l_oCenterHandle = new Element('span', {className: 'centerHandle', id : 'centerhandle', style:'left:'+this.iLeftOffsetRH+'px'}).update('&nbsp;');
	...
	morphTo : function (p_oDateStart, p_oDateEnd) {
		...
		$('centerhandle').morph('left:'+l_offsetLeftLH+'px');
	...
	cutOffStartToYear : function (p_oStartField, p_oEndField, p_oCenterField) {
		this.oStartField = p_oStartField;
		this.oEndField = p_oEndField;
		
		p_oStartField.setValue(Date.parse(p_oStartField.getValue()).toString('yyyy'));
		p_oEndField.setValue(Date.parse(p_oStartField.getValue()).toString('yyyy'));
		p_oCenterField.setValue(Date.parse(p_oStartField.getValue()).toString('yyyy'));
	...
	cutOffStartToMonth : function (p_oStartField, p_oEndField, p_oCenterField) {
		this.oStartField = p_oStartField;
		this.oEndField = p_oEndField;
		
		p_oStartField.setValue(Date.parse(p_oStartField.getValue()).toString('yyyy-MM'));
		p_oEndField.setValue(Date.parse(p_oStartField.getValue()).toString('yyyy-MM'));
		p_oCenterField.setValue(Date.parse(p_oStartField.getValue()).toString('yyyy-MM'));
		// p_oEndField.setValue(Date.parse(p_oEndField.getValue()).toString(this.options.dateFormat));
