...
/* The dateslider */
PreciseDecadeDateSlider = Class.create({
	...
	_setDates : function() {
		...
		if(this.oCenterField) {
			this.oStartField.setValue(l_oDate3.toString(this.options.dateFormat));		
			this.oEndField.setValue(l_oDate3.toString(this.options.dateFormat));		
	...
	_zoom : function(p_iFactor) {
		...
		l_iLeftPos = $('centerhandle').offsetLeft/this.options.dayWidth;
		l_iRightPos = $('centerhandle').offsetLeft/this.options.dayWidth;
		l_iCenterPos = $('centerhandle').offsetLeft/this.options.dayWidth;
